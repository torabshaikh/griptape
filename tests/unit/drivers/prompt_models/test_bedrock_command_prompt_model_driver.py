...
from griptape.drivers import AmazonBedrockPromptDriver, BedrockCommandPromptModelDriver


class TestBedrockCommandPromptModelDriver:
    ...
    def driver(self):
        return AmazonBedrockPromptDriver(
            ...
            prompt_model_driver=BedrockCommandPromptModelDriver(),
            temperature=0.12345,
        ).prompt_model_driver
